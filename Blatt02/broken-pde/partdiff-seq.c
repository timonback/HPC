...
/**            Jacobi method.                                              **/
/**                                                                        **/
/** $Id: partdiff-seq.c,v 1.4 2008-04-17 14:34:21 kunkel Exp $      **/
/**                                                                        **/
/****************************************************************************/
/****************************************************************************/
...
/* ************************************************************************ */
/* checkQuit: exchanges matrices and decides, wether calculation is         */
/*            ready or not.                                                 */
/* ************************************************************************ */
void
checkQuit (void)
{
  ...
  if (termination == TERM_1)	/* ************************ */
    if (maxresiduum < term_precision)	/*  check for stoping       */
      {
	term_iteration = 0;
